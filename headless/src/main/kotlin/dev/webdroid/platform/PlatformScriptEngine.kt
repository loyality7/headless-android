...
public class PlatformScriptEngine(
    ...
    public suspend fun evaluate(
        ...
        val rawResult = dev.webdroid.core.MonotonicTimeout.runWithTimeout(effectiveTimeout, "script") {
            deferred.await()
        }
    ...
    public suspend fun addInitScript(
        ...
        dev.webdroid.core.CapabilityGuard.requireDocumentStartScript(session.capabilities())
